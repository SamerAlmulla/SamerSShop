...
{
	var ref = window.open('http://instagram.com/ps4s_shop', '_blank', 'location=yes');
...
function Openbrowser()
{
	var ref = window.open('http://instagram.com/Every_thing_s', '_blank', 'location=yes');
    ref.addEventListener('loadstart', function(event) { alert(event.url); });
}
...
function OpenBrowser()
{
	var ref = window.open('http://instagram.com/waseet_14', '_blank', 'location=yes');
    ref.addEventListener('loadstart', function(event) { alert(event.url); });
}
